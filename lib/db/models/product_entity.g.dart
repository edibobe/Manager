...
void _productEntitySerialize(
  ...
  writer.writeLong(offsets[1], object.inventory);
...
ProductEntity _productEntityDeserialize(
  ...
  object.inventory = reader.readLong(offsets[1]);
  object.isarId = id;
  object.price = reader.readDouble(offsets[2]);
  object.productId = reader.readString(offsets[3]);
  object.syncedAt = reader.readDateTime(offsets[4]);
...
extension ProductEntityByIndex on IsarCollection<ProductEntity> {
  ...
  Future<List<ProductEntity?>> getAllByProductId(List<String> productIdValues) {
...
extension ProductEntityQuerySortBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortByInventory() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> sortBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQuerySortThenBy
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenByInventory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'inventory', Sort.asc);
    });
  }
  ...
  QueryBuilder<ProductEntity, ProductEntity, QAfterSortBy> thenBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'syncedAt', Sort.asc);
    });
  }
...
extension ProductEntityQueryWhereDistinct
  ...
  QueryBuilder<ProductEntity, ProductEntity, QDistinct> distinctByInventory() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, ProductEntity, QDistinct> distinctBySyncedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductEntityQueryProperty
  ...
  QueryBuilder<ProductEntity, int, QQueryOperations> inventoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProductEntity, DateTime, QQueryOperations> syncedAtProperty() {
    return QueryBuilder.apply(this, (query) {
